...
public:
	...
	void PrintMessage3(string msg) const;
	void PrintMessage4(string msg) const;
	void PrintMessage5(string msg) const;
	...
	int getFileName() const;               //returns the equivalent number of the required input file
